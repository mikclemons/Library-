...
public class Book {
    ...
    // LibraryDemo should have a numberOfBooksInLibrary() method which displays how many Books the user has in their LibraryDemo.
    // In a class named BookDemo, give the user (3) options:
    // they can see how many books they have,
    // add a book to their LibraryDemo,
    // or exit the program.
